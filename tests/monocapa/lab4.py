"""
--- DETECTANDO ANOMALÍAS EN EL PERCEPTRÓN - CELSIUS A FAHRENHEIT ---
...
HIPÓTESIS: El perceptrón tiene la capacidad de poder aprender, este laboratorio se enfoca en el análisis de diferentes perceptrones inicializados.
  |- Si se encuentra un problema durante el entrenamiento o predicción, se debe a el perceptron.
"""
